...
typedef struct liststudent list_t;

student_t *pHead=NULL;
student_t *pTail=NULL;
int g_order=0;

//void insertTopList(list_t *list,const char* name,int lenName,int mark)
//{
//	int i;
...
//}
//
//void insertBotList(list_t *list,const char* name,int lenName,int mark)
//{
//	int i;
//	student_t *newstudent= (student_t*)malloc(sizeof(student_t));
//	
