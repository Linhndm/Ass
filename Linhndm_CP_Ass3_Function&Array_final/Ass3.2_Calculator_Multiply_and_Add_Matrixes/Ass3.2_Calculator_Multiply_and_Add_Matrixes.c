...
int main()
{
	...
	/*Value number of rows and columns for Input matrix*/
	/*Use float variables for check Integer of rows and columns*/
	float r1, c1, r2, c2;
	...
	/* Casting row and col variable to integer */
	row1 = (int)r1;
	row2 = (int)r2;
	col1 = (int)c1;
	col2 = (int)c2;

	/*If cannot Multiply and Add Matrixes, Program will close*/
...
Function : int isMulMatrix()
    ...
    @return:
    			+ True: If Cannot Mutiply two matrixes
    			+ False: If reverse
*/
int isMulMatrix()
{
